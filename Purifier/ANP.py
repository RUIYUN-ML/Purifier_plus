...
path = '/home/jinyulin/Purifier/Checkpoints/MNIST/ResNet18/Blend.pth'
...
save_mask_scores(model.state_dict(), os.path.join('/home/jinyulin/Purifier/', 'mask_values.txt'))
...
def read_data(file_name):
    ...
    return mask_values
mask_values = read_data('/home/jinyulin/Purifier/mask_values.txt')
